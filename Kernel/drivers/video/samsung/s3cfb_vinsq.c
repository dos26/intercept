...
#ifdef CONFIG_MACH_VINSQ //etinum.vinsq.24bpp

    if(system_rev < 0x50) {
            
    	s3c_fimd.wincon0 = S3C_WINCONx_ENLOCAL_DMA | S3C_WINCONx_BUFSEL_0 | S3C_WINCONx_BUFAUTOEN_DISABLE | \
    	...
    	s3c_fimd.wincon1 = S3C_WINCONx_ENLOCAL_DMA | S3C_WINCONx_BUFSEL_0 | S3C_WINCONx_BUFAUTOEN_DISABLE | \
    	           S3C_WINCONx_BITSWP_DISABLE | S3C_WINCONx_BYTSWP_DISABLE | S3C_WINCONx_HAWSWP_ENABLE | \
    	...
    	s3c_fimd.wincon2 = S3C_WINCONx_ENLOCAL_DMA | S3C_WINCONx_BITSWP_DISABLE | S3C_WINCONx_BYTSWP_DISABLE | \
    	...
    	s3c_fimd.wincon3 = S3C_WINCONx_BITSWP_DISABLE | S3C_WINCONx_BYTSWP_DISABLE | S3C_WINCONx_HAWSWP_ENABLE | \
    	...
    	s3c_fimd.wincon4 = S3C_WINCONx_BITSWP_DISABLE | S3C_WINCONx_BYTSWP_DISABLE | S3C_WINCONx_HAWSWP_ENABLE | \
    	           S3C_WINCONx_BURSTLEN_4WORD | S3C_WINCONx_BURSTLEN_16WORD | S3C_WINCONx_BLD_PIX_PLANE |
    	           S3C_WINCONx_BPPMODE_F_16BPP_565 | S3C_WINCONx_ALPHA_SEL_1 | S3C_WINCONx_ENWIN_F_DISABLE;
...
static struct setting_table power_on_setting_table_888[] = {
	{   POWCTL,  7, { 0x80, 0x00, 0x00, 0x0B, 0x33, 0x7F, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },   0 },
	{   VCMCTL,  5, { 0x6E, 0x6E, 0x7F, 0x7F, 0x33, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },   0 },
	{   SRCCTL,  5, { 0x12, 0x00, 0x03, 0xF0, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },   0 },
	{   SLPOUT,  0, { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 120 },
//	{     TEON,  1, { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },   0 },
	{   MADCTL,  1, { 0x48, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },   0 },	
	{   COLMOD,  1, { 0x88, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },  30 },	
	{   DISCTL, 11, { 0x14, 0x14, 0x03, 0x03, 0x04, 0x03, 0x04, 0x10, 0x04, 0x14, 0x14, 0x00, 0x00, 0x00, 0x00 },   0 },	
	{    IFCTL,  4, { 0x00, 0x81, 0x10, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },   0 },	
	{  GATECTL,  2, { 0x22, 0x01, 0x10, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },   0 },	
...
#define POWER_ON_SETTINGS_888	(int)(sizeof(power_on_setting_table_888)/sizeof(struct setting_table))

#if 0//kimhyuns
static struct setting_table power_on_setting_table_888_new[] = {
	{   POWCTL,  7, { 0x80, 0x00, 0x00, 0x0B, 0x33, 0x7F, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },   0 },
	{   VCMCTL,  5, { 0x6E, 0x6E, 0x7F, 0x7F, 0x33, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },   0 },
	{   SRCCTL,  5, { 0x12, 0x00, 0x03, 0xF0, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },   0 },
	{   SLPOUT,  0, { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 120 },
//	{     TEON,  1, { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },   0 },
	...
	{  WRDISBV,  1, { 0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },   0 },	
...
#define POWER_ON_SETTINGS_888_NEW	(int)(sizeof(power_on_setting_table_888_new)/sizeof(struct setting_table))

// Defautl CABC off
static struct setting_table disp_on_setting_table[] = {
	{   WRCTRLD,  1, { 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0 },

// WRCABC - 0x00 : off / 0x01 : UI / 0x02 : Still Image / 0x03 : Moving Image
	{   WRCABC,  1, { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0 },
	{   DISPON,  0, { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },  50 },	
};
#define DISP_ON_SETTINGS	(int)(sizeof(disp_on_setting_table)/sizeof(struct setting_table))
#endif
...
//		gpio_set_value(GPIO_LCD_RST_N, GPIO_LEVEL_LOW); //removed by kimhyuns for hw Kim mijin's asking
        ...
        if(system_rev >= 0x80)
        {
            p_power_set_tbl = power_on_setting_table_888_new;
            tblsize = POWER_ON_SETTINGS_888_NEW;
        }
        else 
#endif
        if(system_rev >= 0x50)
        {
            p_power_set_tbl = power_on_setting_table_888;
            tblsize = POWER_ON_SETTINGS_888;
        }
#endif
...
#ifdef CONFIG_MACH_VINSQ
#if 0//kimhyuns
        // Display on with CABC
        if(system_rev >= 0x80)
        {
    		for (i = 0; i < disp_tblsize; i++)
    			setting_table_write(&p_disp_set_tbl[i]);
        }			
#endif
#endif
...
static void AAT1231_backlight_ctrl(int count)
{
    int i = 0;
    unsigned long flags;
    printk(KERN_DEBUG "kimhyuns ext_lcd_dim_pulse(%d)\n", count);
...
#endif
    {
        ...
        if(count <= 10)
        {
            ...
            printk(KERN_DEBUG "ext_lcd_pulse(%d), HIGH\n", count);
        }
        else
        {
            count = count - 10;
            gpio_set_value( GPIO_LCD_BL_SEL,  GPIO_LEVEL_LOW);
            printk(KERN_DEBUG "ext_lcd_pulse(%d), LOW\n", count);
        }
...
void backlight_ctrl(s32 value)
{
    ...
    int gap;
   	...
   	if (value == 0)
    	...
    	level = 16;
    else if ((value > 31) && (value <= 177))
    	level = 9;
    else if ((value > 177) && (value <= 209))
    	level = 9;	
    else if ((value > 209) && (value <= 241))
    	level = 3;
    else if ((value > 241) && (value <= 255))
    	level = 3;
    else	
    	level = (((value - 32) / 32) + 2); 
#else
//    level = 16-((value+16-1) / 16)+3; 
//    if (level>16) 
//       level=16;
...
#if 1        
        if (value>240)
            value=240;  //ÃÖ´ë ¹à±â 6´Ü°è·Î Á¶Á¤
#endif
        level = 26-(value+(gap-1))/gap + 1; 
    }
#if 0//kimhyuns
    else
    {
        gap=((255+13)/14);
        level = 16-(value+(gap-1))/gap + 1; 
    }
#endif
#endif
#endif
//    printk("value = (%d), gap = (%d) cal=(%d) \n", value, gap, (value+(gap-1))/gap);
    printk(KERN_DEBUG "backlight_ctrl(%d)\n", value);
...
#else
int lcd_late_resume = 0;
//int s3cfb_is_clock_on(void){return 0;}
//void s3cfb_enable_clock_power(){}
#endif
...
#define LOGO_MEM_SIZE		(S3C_FB_HRES * S3C_FB_VRES * 4) //etinum.vinsq.24bpp 2->4
...
#if defined(CONFIG_MACH_VINSQ) || defined(CONFIG_MACH_QUATTRO)
#include "s3cfb_progress_240_400.h"
#define BAR_DST_VRES          356
#define DELTIMER_THRESHOLD    100 /* ECIM-2702128 : 80-> 100 */
...
//	bar_dst = (unsigned short *)(fbi->map_cpu_f1 + (((S3C_FB_HRES * BAR_DST_VRES) + 41) * 2));
	bar_dst = (unsigned short *)(fbi->map_cpu_f1 + (((S3C_FB_HRES * BAR_DST_VRES) + 18) * 2));
...
#if defined(CONFIG_MACH_VINSQ) || defined(CONFIG_MACH_QUATTRO)
  bg_src = (unsigned short *)(progress_bg_240_400 + sizeof(progress_bg_240_400) - 2);
#else
...
#if 1//kimhyuns_temporary def CONFIG_FB_S3C_BPP_24
	writel(s3c_fimd.wincon0,    S3C_WINCON0);
  	s3cfb_onoff_win(&s3c_fb_info[0], ON);
#endif	
