...
#define GPIO_SENSOR_SCL		    		S3C64XX_GPA(0)
#define GPIO_SENSOR_SCL_AF	    			1

#define GPIO_SENSOR_SDA		    		S3C64XX_GPA(1)
#define GPIO_SENSOR_SDA_AF	    			1
#endif
#endif
...
#define GPIO_SCAM_RST_N_AF			1

#define GPIO_SCAM_STANDBY			S3C64XX_GPC(1)
#define GPIO_SCAM_STANDBY_AF			1

#define GPIO_LCD_BL_SCL_N        S3C64XX_GPC(2)
#define GPIO_LCD_BL_SCL_N_AF         1

#define GPIO_LCD_BL_SDA_N        S3C64XX_GPC(3)
#define GPIO_LCD_BL_SDA_N_AF         1
#endif
#endif
...
#define GPIO_LCD_BL_SEL        S3C64XX_GPH(1)
#define GPIO_LCD_BL_SEL_AF         1
...
#define GPIO_BL_RST					S3C64XX_GPH(4)
#define GPIO_BL_RST_AF				1
#endif
...
#if defined (CONFIG_MACH_MAX)
//Interrupt Type
#define GPIO_MONOHEAD_DET_ISR			S3C64XX_GPL(13)
#define GPIO_MONOHEAD_DET_ISR_AF        3
// Polling Type
...
#if defined (CONFIG_MACH_MAX)
#define GPIO_BATT_ID				S3C64XX_GPN(4)
#define GPIO_BATT_ID_AF				2
#else
