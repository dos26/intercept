...
static struct i2c_board_info __initdata bd60910gu_i2c_board_info[] = {
    {
    	I2C_BOARD_INFO("bd60910gu-backlight", 0x76),
    },
};
...
static struct i2c_gpio_platform_data i2c6_platdata = {
	.sda_pin		= GPIO_SENSOR_SDA/*GPIO_TOUCH_I2C_SDA*/,
	.scl_pin		= GPIO_SENSOR_SCL/*GPIO_TOUCH_I2C_SCL*/,
	.udelay			= 3,	/* 166KHz */		
	.sda_is_open_drain	= 0,
	.scl_is_open_drain	= 0,
	.scl_is_output_only	= 1,
...
#endif
#if defined(CONFIG_MACH_VINSQ) || defined(CONFIG_MACH_QUATTRO) || defined(CONFIG_MACH_MAX)
static struct platform_device *instinctq_devices_07[] __initdata = {
#if defined(CONFIG_S3C_DMA_PL080_SOL)
	&s3c_device_dma0,
	&s3c_device_dma1,
	&s3c_device_dma2,
...
static int instinctq_notifier_call(struct notifier_block *this, unsigned long code, void *_cmd)
{
	...
	if ((code == SYS_RESTART) && _cmd) {
		...
		else if (!strcmp((char *)_cmd, "bootloader")) //etinum.adb.reboot bootloader
...
static void __init instinctq_machine_init(void)
{
	...
	if(system_rev>=CONFIG_VITAL_REV01)
		i2c_register_board_info(4, bd60910gu_i2c_board_info, ARRAY_SIZE(bd60910gu_i2c_board_info)); //vital.boot
	else
	{
		sec_headset_port[0].det_headset.low_active=0;
		i2c_register_board_info(6, bd60910gu_i2c_board_info, ARRAY_SIZE(bd60910gu_i2c_board_info)); //vital.boot
	}
#endif
...
#if defined(CONFIG_MACH_MAX)
	platform_add_devices(instinctq_devices_07, ARRAY_SIZE(instinctq_devices_07));
#elif defined (CONFIG_MACH_VITAL)
...
MACHINE_START(INSTINCTQ, "SWD-S500")
#elif defined(CONFIG_MACH_MAX)
MACHINE_START(INSTINCTQ, "SCH-I100")
#else
...
static int instinctq_gpio_table[][6] = {
	...
	/* GPH */
//	{ GPIO_MAIN_KEY_LED_EN, 1, GPIO_LEVEL_HIGH, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE },
...
static int instinctq_gpio_table[][6] = {
	...
	{ GPIO_CAM_D_6, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_DOWN, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN },
	{ GPIO_CAM_D_7, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_DOWN, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN },
	{ GPIO_MIC_SEL_EN_REV04, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE },
	{ GPIO_LUM_PWM, 1, GPIO_LEVEL_HIGH, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE },
	{ GPIO_PWM1_TOUT, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_DOWN, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN },
	/* GPG */
	{ GPIO_TF_CLK, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_DOWN, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN },
...
//.m [VinsQ] [End] Charger IC Changed to MAX8922    hgwoo    2010.01.05
	...
	{ GPIO_TA_CONNECTED_N, GPIO_TA_CONNECTED_N_AF, GPIO_LEVEL_NONE, S3C_GPIO_PULL_UP, 0, 0 },
	{ GPIO_PS_VOUT, GPIO_PS_VOUT_AF, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_MONOHEAD_DET_ISR, GPIO_MONOHEAD_DET_ISR_AF, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_BT_HOST_WAKE, GPIO_BT_HOST_WAKE_AF, GPIO_LEVEL_NONE, S3C_GPIO_PULL_DOWN, 0, 0 },
	/* GPM */
	{ GPIO_FM_I2C_SCL, GPIO_FM_I2C_SCL_AF, GPIO_LEVEL_HIGH, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_FM_I2C_SDA, GPIO_FM_I2C_SDA_AF, GPIO_LEVEL_HIGH, S3C_GPIO_PULL_NONE, 0, 0 },
	...
	{ GPIO_MSENSE_INT, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_ACC_INT, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_BATT_ID, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_POWER_N, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_TF_DETECT, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_PHONE_ACTIVE, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_TOUCH_INT, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
...
static int instinctq_gpio_table[][6] = {
	...
	{ GPIO_I2C1_SCL, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_DOWN, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN },
	{ GPIO_I2C1_SDA, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_DOWN, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN },
	{ GPIO_TFLASH_EN, GPIO_TFLASH_EN_AF, GPIO_LEVEL_HIGH, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE }, //quattro.tflash
	...
	/* GPC */
	{ GPIO_BT_WAKE, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE },
	{ GPIO_WIMAX_USBEN, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_DOWN, S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE },
	{ GPIO_MAIN_KEY_LED_EN, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE },
	{ GPIO_SUB_KEY_LED_EN, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE },	
	...
	{ GPIO_WIAMX_SDIO_CMD, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE },
	{ GPIO_WIMAX_SDIO_CLK, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_DOWN, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN },
	{ GPIO_WLAN_WAKE, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE },
	{ GPIO_WIMAX_PWREN, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE },
	/* GPD */
	{ GPIO_I2S_CLK, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_DOWN, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN },
	{ GPIO_BT_WLAN_REG_ON, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE },
	{ GPIO_I2S_LRCLK, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_DOWN, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN },
	...
	{ GPIO_WLAN_D_2, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE },
	{ GPIO_WLAN_D_3, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE },
	{ GPIO_WIMAX_SDIO_D_0, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE },
	{ GPIO_WIMAX_SDIO_D_1, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE },
	{ GPIO_WIMAX_SDIO_D_2, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE },
	{ GPIO_WIMAX_SDIO_D_3, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE },
	/* GPI */
	{ GPIO_LCD_B_0, GPIO_LCD_B_0_AF, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN },
	{ GPIO_LCD_B_1, GPIO_LCD_B_1_AF, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN },
	{ GPIO_LCD_B_2, GPIO_LCD_B_2_AF, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN },
	...
	{ GPIO_MICBIAS_EN, GPIO_MICBIAS_EN_AF, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_UART_SEL, GPIO_UART_SEL_AF, GPIO_LEVEL_HIGH, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_USB_SW_EN_WIMAX, GPIO_USB_SW_EN_WIMAX_AF, GPIO_LEVEL_HIGH, S3C_GPIO_PULL_NONE, 0, 0 },
	...
	{ GPIO_CHG_ING_N, GPIO_CHG_ING_N_AF, GPIO_LEVEL_NONE, S3C_GPIO_PULL_UP, 0, 0 },
	{ GPIO_PDA_ACTIVE, GPIO_PDA_ACTIVE_AF, GPIO_LEVEL_HIGH, S3C_GPIO_PULL_NONE, 0, 0 }, 
	{ GPIO_UART_SEL2, GPIO_UART_SEL_AF, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_CAM_STANDBY, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE },
	/* GPN */
	{ GPIO_ONEDRAM_INT_N, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_WLAN_HOST_WAKE, GPIO_WLAN_HOST_WAKE_AF, GPIO_LEVEL_NONE, S3C_GPIO_PULL_DOWN, 0, 0 },
	...
	{ GPIO_JACK_INT_N, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_WIMAX_INT, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_EAR_SEND_END, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_RESOUT_N, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_UP, 0, 0 },
	{ GPIO_BOOT_EINT13, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_BOOT_EINT14, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_BOOT_EINT15, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
	/* GPO */
	{ GPIO_WIMAX_RESET_N, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE },
	/** MEMORY PART **/
	/* GPP */
	{ S3C64XX_GPP(8), 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE },
	{ S3C64XX_GPP(10), 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE },
	{ S3C64XX_GPP(14), 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE },
	/* GPQ */
	{ GPIO_WIMAX_CON2, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE },
	{ GPIO_WIMAX_IF_MODE0, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE },
	{ GPIO_WIMAX_IF_MODE1, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE },
	{ GPIO_WIMAX_WAKEUP, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE },
	{ GPIO_WIMAX_CON0, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE },
	{ GPIO_WIMAX_CON1, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE },
};
...
void s3c_show_gpio_set(int gpio_bank)
{
	u32 gpxcon[16];
	u32 gpxcon1[16];
	u32 gpxdat[16];
	...
	if((gpio_bank<=S3C64XX_GPECON)||(gpio_bank==S3C64XX_GPGCON)){
		printk("gpxcon 0:input 1:output, gpxdat:, gpxpud 1:PD 2:PU, gpxconslp 0,1:Output 2:input, gpxpudslp 1:PD 2:PU\n");			
		for(i=0;i<=7;i++)
			{
				gpxcon[i] = ((__raw_readl(gpio_bank))&(0xF<<(4*i))>>(4*i))&0xF;
				gpxdat[i] = (__raw_readl(gpio_bank+0x04))&(0x1<<(i))>>(i);
				gpxpud[i] = (__raw_readl(gpio_bank+0x08))&(0x3<<(2*i))>>(2*i);
				gpxconslp[i] = (__raw_readl(gpio_bank+0x0C))&(0x3<<(2*i))>>(2*i);
				gpxpudslp[i] = (__raw_readl(gpio_bank+0x10))&(0x3<<(2*i))>>(2*i);
				printk("gpxcon[%d]:%x, gpxdat[%d]:%x, gpxpud[%d]:%x, gpxconslp[%d]:%x, gpxpudslp[%d]:%x\n",i,gpxcon[i],i,gpxdat[i],i,gpxpud[i],i,gpxconslp[i],i,gpxpudslp[i]);
			}		
	}
	else if((gpio_bank==S3C64XX_GPFCON)||(gpio_bank==S3C64XX_GPICON)||(gpio_bank==S3C64XX_GPJCON)||(gpio_bank==S3C64XX_GPOCON)\
		||(gpio_bank==S3C64XX_GPPCON)||(gpio_bank==S3C64XX_GPQCON)){
		printk("gpxcon 0:input 1:output, gpxdat:, gpxpud 1:PD 2:PU, gpxconslp 0,1:Output 2:input, gpxpudslp 1:PD 2:PU\n");			
		for(i=0;i<=15;i++)
			{
				gpxcon[i] = ((__raw_readl(gpio_bank))&(0x3<<(2*i))>>(2*i))&0x3;
				gpxdat[i] = (__raw_readl(gpio_bank+0x04))&(0x1<<(i))>>(i);
				gpxpud[i] = ((__raw_readl(gpio_bank+0x08))&(0x3<<(2*i))>>(2*i))&0x3;
				gpxconslp[i] = ((__raw_readl(gpio_bank+0x0C))&(0x3<<(2*i))>>(2*i))&0x3;
				gpxpudslp[i] = ((__raw_readl(gpio_bank+0x10))&(0x3<<(2*i))>>(2*i))&0x3;
				printk("gpxcon[%d]:%x, gpxdat[%d]:%x, gpxpud[%d]:%x, gpxconslp[%d]:%x, gpxpudslp[%d]:%x\n",i,gpxcon[i],i,gpxdat[i],i,gpxpud[i],i,gpxconslp[i],i,gpxpudslp[i]);
			}		
	}
	else if(gpio_bank==S3C64XX_GPHCON0){
		printk("gpxcon 0:input 1:output, gpxdat:, gpxpud 1:PD 2:PU, gpxconslp 0,1:Output 2:input, gpxpudslp 1:PD 2:PU\n");			
		for(i=0;i<=9;i++)
			{
			    if(i<8){
				  ...
				  gpxcon[i] = ((__raw_readl(gpio_bank+0x04))&(0xF<<(4*(i-8)))>>(4*(i-8)))&0xF;
				}
				gpxdat[i] = (__raw_readl(gpio_bank+0x08))&(0x1<<(i))>>(i);
				gpxpud[i] = (__raw_readl(gpio_bank+0x0C))&(0x3<<(2*i))>>(2*i);
				gpxconslp[i] = (__raw_readl(gpio_bank+0x10))&(0x3<<(2*i))>>(2*i);
				gpxpudslp[i] = (__raw_readl(gpio_bank+0x14))&(0x3<<(2*i))>>(2*i);
				printk("gpxcon[%d]:%x, gpxdat[%d]:%x, gpxpud[%d]:%x, gpxconslp[%d]:%x, gpxpudslp[%d]:%x\n",i,gpxcon[i],i,gpxdat[i],i,gpxpud[i],i,gpxconslp[i],i,gpxpudslp[i]);
			}		
	}
	else if((gpio_bank==S3C64XX_GPKCON)||(gpio_bank==S3C64XX_GPLCON)){
		...
		for(i=0;i<=15;i++)
			{
				...
				printk("gpxcon[%d]:%x, gpxdat[%d]:%x, gpxpud[%d]:%x\n",i,gpxcon[i],i,gpxdat[i],i,gpxpud[i]);
			}		
	}
	else if(gpio_bank==S3C64XX_GPMCON){
		printk("gpxcon 0:input 1:output, gpxdat:, gpxpud 1:PD 2:PU\n");			
		for(i=0;i<=5;i++)
			{
				gpxcon[i] = ((__raw_readl(gpio_bank))&(0xF<<(4*i))>>(4*i))&0xF;
	...
	else if(gpio_bank==S3C64XX_GPNCON){
		printk("gpxcon 0:input 1:output, gpxdat:, gpxpud 1:PD 2:PU\n");			
		for(i=0;i<=15;i++)
			{
				gpxcon[i] = ((__raw_readl(gpio_bank))&(0x3<<(2*i))>>(2*i))&0x3;
...
EXPORT_SYMBOL(s3c_show_gpio_set);

void s3c_print_gpio_set()
{
    printk("===========GPA==========\n");
    s3c_show_gpio_set(S3C64XX_GPACON);
    printk("===========GPB==========\n");
    s3c_show_gpio_set(S3C64XX_GPBCON);
    printk("===========GPC==========\n");
    s3c_show_gpio_set(S3C64XX_GPCCON);
    printk("===========GPD==========\n");
    s3c_show_gpio_set(S3C64XX_GPDCON);
    printk("===========GPE==========\n");
    s3c_show_gpio_set(S3C64XX_GPECON);
    printk("===========GPF==========\n");
    s3c_show_gpio_set(S3C64XX_GPFCON);
    printk("===========GPG==========\n");
    s3c_show_gpio_set(S3C64XX_GPGCON);
	printk("===========GPH==========\n");
    s3c_show_gpio_set(S3C64XX_GPHCON0);
    printk("===========GPI==========\n");
    s3c_show_gpio_set(S3C64XX_GPICON);
    printk("===========GPJ==========\n");
    s3c_show_gpio_set(S3C64XX_GPJCON);
    printk("===========GPK==========\n");
    s3c_show_gpio_set(S3C64XX_GPKCON);
    printk("===========GPL==========\n");
    s3c_show_gpio_set(S3C64XX_GPLCON);
    printk("===========GPM==========\n");
    s3c_show_gpio_set(S3C64XX_GPMCON);
    printk("===========GPN==========\n");
    s3c_show_gpio_set(S3C64XX_GPNCON);
	printk("===========GPO==========\n");
    s3c_show_gpio_set(S3C64XX_GPOCON);
    printk("===========GPP==========\n");
    s3c_show_gpio_set(S3C64XX_GPPCON);
	printk("===========GPQ==========\n");
    s3c_show_gpio_set(S3C64XX_GPQCON);
}
EXPORT_SYMBOL(s3c_print_gpio_set);
...
void s3c_config_wakeup_source(void)
{
	...
	// __FUEL_GAUGES_IC_MAX17043_SLEEP_ALERT__ Added WakeUp Source GPN12 (Interrupt 12) -> Fuel Gauge(MAX17043) Sleep Wake function implemented..

	
	eint0pend_val = __raw_readl(S3C64XX_EINT0PEND);
#if defined(CONFIG_MACH_VINSQ) //add EINT21(SEND_END for new headset)
	...
	// add EINT7(PHONE_ACTIVE for modem watchdog reset monitor)
	eint0pend_val |= (0x1 << 7);
#elif defined(CONFIG_MACH_VITAL)
    if(system_rev==CONFIG_VITAL_REV00)
    {
        if(get_headset_status()==0)//hw bug
        	eint0pend_val |= (0x1 << 25) | (0x1 << 22) |(0x1 << 20) |  (0x1 << 19) | (0x1 << 12) | 
    		(0x1 << 10) | (0x1 << 9) | (0x1 << 6) | (0x1 << 5) | (0x1 << 4) | (0x1 << 1) |  0x1;
