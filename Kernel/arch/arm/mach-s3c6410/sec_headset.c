...
#if defined(CONFIG_MACH_VITAL)
	gpio_set_value(GPIO_EAR_MIC_BIAS, 0); //to reduce noise when Injection Earjack
	msleep(300); //kimhyuns fix no sound bug when insert or pull up earjack
